-- Add individual statement totals to comparisons table
-- This allows breaking down withdrawals and deposits by statement

ALTER TABLE comparisons 
ADD COLUMN statement1_withdrawals DECIMAL(10,2) DEFAULT 0,
ADD COLUMN statement1_deposits DECIMAL(10,2) DEFAULT 0,
ADD COLUMN statement2_withdrawals DECIMAL(10,2) DEFAULT 0,
ADD COLUMN statement2_deposits DECIMAL(10,2) DEFAULT 0;
